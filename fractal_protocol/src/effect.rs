...
impl EffectId {
    pub fn get_display_name(&self) -> Option<&'static str> {
        let s = match self {
            ...
            EffectId::ID_FORMANT1 => "Formant 1",
            EffectId::ID_FORMANT2 => "Formant 2",
            EffectId::ID_FORMANT3 => "Formant 3",
            EffectId::ID_FORMANT4 => "Formant 4",
            EffectId::ID_MEGATAP1 => "Megatap Delay 1",
            EffectId::ID_MEGATAP2 => "Megatap Delay 2",
            EffectId::ID_MEGATAP3 => "Megatap Delay 3",
            EffectId::ID_MEGATAP4 => "Megatap Delay 4",
            EffectId::ID_CROSSOVER1 => "Crossover 1",
            EffectId::ID_CROSSOVER2 => "Crossover 2",
            EffectId::ID_CROSSOVER3 => "Crossover 3",
            EffectId::ID_CROSSOVER4 => "Crossover 4",
            EffectId::ID_GATE1 => "Gate/Expander 1",
            EffectId::ID_GATE2 => "Gate/Expander 2",
            EffectId::ID_GATE3 => "Gate/Expander 3",
            EffectId::ID_GATE4 => "Gate/Expander 4",
            EffectId::ID_RINGMOD1 => "Ring Modulator 1",
            EffectId::ID_RINGMOD2 => "Ring Modulator 2",
            EffectId::ID_RINGMOD3 => "Ring Modulator 3",
            EffectId::ID_RINGMOD4 => "Ring Modulator 4",
            EffectId::ID_MULTICOMP1 => "Multiband Comp. 1",
            EffectId::ID_MULTICOMP2 => "Multiband Comp. 2",
            EffectId::ID_MULTICOMP3 => "Multiband Comp. 3",
            EffectId::ID_MULTICOMP4 => "Multiband Comp. 4",
            EffectId::ID_TENTAP1 => "Ten-Tap Delay 1",
            EffectId::ID_TENTAP2 => "Ten-Tap Delay 2",
            EffectId::ID_TENTAP3 => "Ten-Tap Delay 3",
            EffectId::ID_TENTAP4 => "Ten-Tap Delay 4",
            EffectId::ID_RESONATOR1 => "Resonator 1",
            EffectId::ID_RESONATOR2 => "Resonator 2",
            EffectId::ID_RESONATOR3 => "Resonator 3",
            EffectId::ID_RESONATOR4 => "Resonator 4",
            EffectId::ID_LOOPER1 => "Looper 1",
            EffectId::ID_LOOPER2 => "Looper 2",
            EffectId::ID_LOOPER3 => "Looper 3",
            EffectId::ID_LOOPER4 => "Looper 4",
            EffectId::ID_TONEMATCH1 => "Tonematch 1",
            EffectId::ID_TONEMATCH2 => "Tonematch 2",
            EffectId::ID_TONEMATCH3 => "Tonematch 3",
            EffectId::ID_TONEMATCH4 => "Tonematch 4",
            EffectId::ID_RTA1 => "Realtime Analyzer 1",
            EffectId::ID_RTA2 => "Realtime Analyzer 2",
            EffectId::ID_RTA3 => "Realtime Analyzer 3",
            EffectId::ID_RTA4 => "Realtime Analyzer 4",
            EffectId::ID_PLEX1 => "Plex Delay 1",
            EffectId::ID_PLEX2 => "Plex Delay 2",
            EffectId::ID_PLEX3 => "Plex Delay 3",
            EffectId::ID_PLEX4 => "Plex Delay 4",
            EffectId::ID_FBSEND1 => "Feedback Send 1",
            EffectId::ID_FBSEND2 => "Feedback Send 2",
            EffectId::ID_FBSEND3 => "Feedback Send 3",
            EffectId::ID_FBSEND4 => "Feedback Send 4",
            EffectId::ID_FBRETURN1 => "Feedback Return 1",
            EffectId::ID_FBRETURN2 => "Feedback Return 2",
            EffectId::ID_FBRETURN3 => "Feedback Return 3",
            EffectId::ID_FBRETURN4 => "Feedback Return 4",
            EffectId::ID_MIDIBLOCK => "MIDI Block",
            EffectId::ID_MULTIPLEXER1 => "Multiplexer 1",
            EffectId::ID_MULTIPLEXER2 => "Multiplexer 2",
            EffectId::ID_MULTIPLEXER3 => "Multiplexer 3",
            EffectId::ID_MULTIPLEXER4 => "Multiplexer 4",
            EffectId::ID_IRPLAYER1 => "IR Player 1",
            EffectId::ID_IRPLAYER2 => "IR Player 2",
            EffectId::ID_IRPLAYER3 => "IR Player 3",
            EffectId::ID_IRPLAYER4 => "IR Player 4",

            EffectId::ID_CONTROL | EffectId::ID_TUNER | EffectId::ID_IRCAPTURE |
            EffectId::ID_FOOTCONTROLLER | EffectId::ID_PRESET_FC | EffectId::ID_EFFECTS_END => return None
        };
        Some(s)
    }
}
